...
export const metadata: Metadata = {
  title: "Investor Briefing — February 3, 2026 | Rebel Dividends",
  description: "Archived Rebel Dividends investor briefing for the week of February 3, 2026.",
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-20 text-center space-y-6">
        ...
        <p className="text-gray-400 text-lg">February 3, 2026</p>
        <p className="text-gray-500 max-w-md mx-auto text-sm leading-relaxed">
          This briefing was sent to Rebel Dividends investors on February 3, 2026.
