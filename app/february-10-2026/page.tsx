...
export const metadata: Metadata = {
  title: "Investor Briefing — February 10, 2026 | Rebel Dividends",
  description: "Archived Rebel Dividends investor briefing for the week of February 10, 2026.",
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="border-b border-gray-800 bg-gray-900/60 backdrop-blur">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-gray-500 text-sm">February 10, 2026</span>
        </div>
      </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-20 text-center space-y-6">
        ...
        <p className="text-gray-400 text-lg">February 10, 2026</p>
        <p className="text-gray-500 max-w-md mx-auto text-sm leading-relaxed">
          This briefing was sent to Rebel Dividends investors on February 10, 2026.
